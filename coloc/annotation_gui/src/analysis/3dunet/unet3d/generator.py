...
def get_training_and_validation_generators(data_file, batch_size, n_labels, training_keys_file, validation_keys_file,
                                           ...
                                           augment_blur=False, augment_intensity_factor=0.25):
    """
    ...
    training_generator = data_generator(data_file, training_list,
                                        ...
                                        augment_intensity_factor=augment_intensity_factor,
...
def data_generator(data_file, index_list, batch_size=1, n_labels=1, labels=None, augment=False, augment_flip=True,
                   augment_distortion_factor=0.25, augment_blur=True, augment_intensity_factor=0.25,
                   patch_shape=None, patch_overlap=0, patch_start_offset=None, shuffle_index_list=False,
    ...
    while True:
        ...
        while len(index_list) > 0:
            ...
            add_data(x_list, y_list, data_file, index, augment=augment, augment_flip=augment_flip,
                     ...
                     skip_blank=skip_blank, permute=permute, augment_blur=augment_blur,
                     augment_intensity_factor=augment_intensity_factor)
...
def add_data(x_list, y_list, data_file, index, augment=False, augment_flip=False, augment_distortion_factor=0.25,
             patch_shape=False, skip_blank=True, permute=False, augment_blur=False, augment_intensity_factor=0.25):
    """
    ...
    if augment:
        ...
        data, truth = augment_data(data, truth, affine, flip=augment_flip, scale_distortion=augment_distortion_factor,
                                   blur=augment_blur, scale_intensity=augment_intensity_factor)
