...
python -m cellpose/cellpose --use_gpu --gpu_device 1 --image_path $IMG_PATH --pretrained_model ../downloads/train_data/data_P4_P15/train/models/cellpose_residual_on_style_on_concatenation_off_train_2023_05_15_12_23_32.710910_epoch_61 --do_3D --save_tif --no_npy --verbose --savedir ../downloads/train_data/test_out >> test_log_$NOW.txt
