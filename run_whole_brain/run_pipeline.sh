...
# nohup python run_whole_brain/run_stitch_step.py L91D814P2 pair21 >> log_$NOW.out
# # nohup python run_whole_brain/run_stitch_step.py L91D814P6 pair21 >> log_$NOW.out 
# nohup python run_whole_brain/run_stitch_step.py L91D814P3 pair22 >> log_$NOW.out
# nohup python run_whole_brain/run_stitch_step.py L91D814P4 pair22 >> log_$NOW.out 
